...
animate(soil_anim, nframes = length(unique(soil_long$Date)) * 3, fps = 5, width = 600, height = 400, units = "px", renderer = gifski_renderer("soil_animation.gif"))
...
animate(rhizon_anim1, nframes = length(unique(rhizon_long1$Sampled_on)) * 3, fps = 5, width = 600, height = 400, units = "px", renderer = gifski_renderer("rhizon_anim_group1.gif"))
...
animate(rhizon_anim2, nframes = length(unique(rhizon_long2$Sampled_on)) * 3, fps = 5, width = 600, height = 400, units = "px", renderer = gifski_renderer("rhizon_anim_group2.gif"))
...
animate(prs_macro_anim, nframes = length(unique(prs_macro_long$Retrieval.Date)) * 3, fps = 5, width = 600, height = 400, units = "px", renderer = gifski_renderer("prs_macro_anim.gif"))
...
animate(prs_micro_anim, nframes = length(unique(prs_micro_long$Retrieval.Date)) * 3, fps = 5, width = 600, height = 400, units = "px", renderer = gifski_renderer("prs_micro_anim.gif"))
```
...
![](rhizon_anim_group1.gif)

**Porewater elements**
![](rhizon_anim_group2.gif)

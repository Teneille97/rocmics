---
--- title: "CN_nov2025" author: "Teneille Nel" format: html editor: visual ---
---
...
Performing combustion analysis (assuming zero soil inorganic carbon, confirmed by calcimetry tests) and rendering with `ggthemr('fresh')`, displays these plots:

```{r} #| echo: FALSE #| message: FALSE #| label: CN_all_treatments #| warning: FALSE}
...
##Subsetting for selected treatments

```{r} #| echo: true #| message: false #| label: selected_treatments #| warning: FALSE}
...
```{r} #| echo: true #| message: false #| label: dose-response #| warning: FALSE}
...
Most treatments seem to have changed minimally or even decreased. Could be that LOI underestimates SOC, or CN overestimates it.

...
Since calcimetry showed no SIC, we expected **no HCl effect and can eliminate** this analysis going forward. Not sure if **H2O2 will become more significant with improved recovery?** (syringe to remove supernatant below light fraction, followed by centrifuge). **NaOH had significant increase in clay-silt** fraction. Viewing the results of pairwise tests of clay/silt class shows that **oxalate was also almost significant** (confident this will become even more clear with the planned, **larger sample size** of 20g and including plot replicates:

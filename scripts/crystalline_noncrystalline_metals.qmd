---
title: "crystalline_noncrystalline_metals"
format: html
date: "`r Sys.Date()`"
editor: visual
---
...
Extracting non-crystalline sesquioxides in 2M oxalate yields the following metal concentrations. We observe more metals released from Bolsdorfer treatment, especially Si.
...
Huhnerberg dose response clearly shows Al & Mn decrease, probably going into more cyrstalline mineral formation or Al is substituting for Fe in poorly-crystalline ferrihydrite (formed after Fe released from basalt, is oxidized) and Mn is sorbing to ferrihydrite or forming its own/ mixed oxides.

...
Normalizing each measured parameter **across all treatments** and plotting a time-series with `gganimate` (this only works in a separate R script, not in Quarto for some reason), displays these gifs:

**Soil Animation** ![](soil_animation.gif)

**Rhizon alkalinity animation** ![](rhizon_animation1.gif)

**Rhizon elements animation** ![](rhizon_animation2.gif)

**PRS macroelements animation** ![](prs_macro_anim.gif)

**PRS microelements animation** ![](prs_micro_anim.gif)

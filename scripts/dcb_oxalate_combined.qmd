...
We observe more oxalate-extractable metals released from Bolsdorfer treatment, especially Si. In the dose-response experiment, Huhnerberg dose response clearly shows oxalate-extractable Al & Mn decrease, probably going into more crystalline mineral formation or Al is substituting for Fe in poorly-crystalline ferrihydrite (formed after Fe released from basalt, is oxidized) and Mn is sorbing to ferrihydrite or forming its own/ mixed oxides. 
...
We then compared ratios of amorphous to crystalline elements among different treatments. DCB solution, which is more neutral to alkaline pH, is designed to reduce Fe oxides, but does not fully dissolve amorphous aluminosilicates formed by ERW, while acidic oxalate is more efficient at dissolving these. Therefore, we see much higher oxalate-Si relative to DCB-Si in the Bolsdorfer treatment. Meanwhile, iron-bearing minerals in the basalts release Fe2+ upon weathering, which can oxidize and form crystalline iron oxides, which explains why we see a bit more DCB-Fe relative to oxalate-Fe in the treatments compared to control.

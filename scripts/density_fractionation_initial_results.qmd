---
title: "density_fractionation_initial_results"
format: html
author: "Teneille Nel"
date: "`r Sys.Date()`"
editor: visual
...
This script is available at <https://quarto.org> 
I performed density fractionation using method...
...
We measured C content by combustion and multiplied the %C of each pool by the proportion of that pool as a fraction of the bulk to determine the distribution of bulk soil C among pools:
...
We also normalized the % change to the control as (treatment-control)/control x 100%

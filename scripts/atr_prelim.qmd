...
- **Control Treatment Dynamics:**
  ...
  - Extraction induced a highly consistent shift in the carboxylate environment, characterized by a **decrease in the** $COO^-$\$COO\^-\$ asymmetric stretching region and a corresponding **increase in the** $COO^-$ symmetric stretching region.

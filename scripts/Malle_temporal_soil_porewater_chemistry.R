...
write.csv(Alldata_Soil_phEC,file=here::here("outputs","Alldata_Soil_phEC_cleaned.csv"), row.names=FALSE)
...
anim_save("docs/soil_animation.gif", animation = soil_anim_gif)
...
anim_save("docs/rhizon_animation1.gif", animation = rhizon_anim1_gif)
...
anim_save("docs/rhizon_animation2.gif", animation = rhizon_anim2_gif)
...
anim_save("docs/prs_macro_anim.gif", animation = prs_macro_anim_gif)
...
anim_save("docs/prs_micro_anim.gif", animation = prs_micro_anim_gif)
